      ...
      <div className="bg-blue-500 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">
            Welcome to the Ultimate Polling Experience!
          </h1>
          <p className="text-lg mb-6">
            Discover, participate, and create polls on a variety of topics.
            Engage with the community and see what others think!
          </p>
          {currentUser ? (
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {allPolls.map((poll) => (
              <PollItem
                key={poll._id}
                poll={poll}
                displayFirstAndLastOption={true}
              />
            ))}
          </div>
        )}
